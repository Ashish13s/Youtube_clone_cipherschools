  ...
  return (
    <Link to="/video/test/" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://img.youtube.com/vi/5hFd6zGkxLE/maxresdefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>THANK YOU, CRISTIANO RONALDO | Real Madrid Official Video</Title>
            <ChannelName>Real Madrid</ChannelName>
            <Info>5 million views • 14 days ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>

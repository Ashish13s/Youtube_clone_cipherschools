  ...
  return (
    <Link to="/video/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://img.youtube.com/vi/IM3fObxRIC8/sddefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>Another MAGICAL Champions League night! | Real Madrid 2-1 Shakhtar</Title>
            <ChannelName>Real Madrid</ChannelName>
            <Info>1 million views • 8 days ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>

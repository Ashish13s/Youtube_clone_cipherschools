  ...
  return (
    <Link to="/video/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://img.youtube.com/vi/KrgKn_vEr5Y/maxresdefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>Real Madrid 5-1 Celtic | Highlights | Champions League</Title>
            <ChannelName>Real Madrid</ChannelName>
            <Info>3 million views • 4 days ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>

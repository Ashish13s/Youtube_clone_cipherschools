  ...
  return (
    <Link to="/video/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://img.youtube.com/vi/HRd41d2QB6Q/sddefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>All out to seal qualification | Shakhtar - Real Madrid Champions League</Title>
            <ChannelName>Real Madrid</ChannelName>
            <Info>2 million views • 7 days ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>

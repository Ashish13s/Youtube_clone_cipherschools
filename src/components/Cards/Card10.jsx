  ...
  return (
    <Link to="/video/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://img.youtube.com/vi/hbyrVqN0jbM/sddefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>AMAZING COMEBACK | Liverpool 2-5 Real Madrid | Champions League</Title>
            <ChannelName>Real Madrid</ChannelName>
            <Info>6 million views • 1 days ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>

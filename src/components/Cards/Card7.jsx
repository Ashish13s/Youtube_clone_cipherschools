  ...
  return (
    <Link to="/video/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://img.youtube.com/vi/J8hm4LCpMIE/maxresdefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>RB Leipzig 3-2 Real Madrid | HIGHLIGHTS | Champions League 2022/23</Title>
            <ChannelName>Real Madrid</ChannelName>
            <Info>2.2 million views • 5 days ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>

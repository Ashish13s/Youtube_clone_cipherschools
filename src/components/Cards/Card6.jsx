  ...
  return (
    <Link to="/video/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://img.youtube.com/vi/Euk7Mt1CUD8/sddefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>LIVE | Our final training session ahead of RB Leipzig!</Title>
            <ChannelName>Real Madrid</ChannelName>
            <Info>1.5 million views • 7 days ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>

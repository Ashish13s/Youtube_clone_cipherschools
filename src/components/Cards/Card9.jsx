  ...
  return (
    <Link to="/video/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://img.youtube.com/vi/zRqCw7vDfOM/sddefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>The Champions League CHAMPION IS BACK | Celtic-Real Madrid</Title>
            <ChannelName>Real Madrid</ChannelName>
            <Info>2.6 million views • 3 days ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>
